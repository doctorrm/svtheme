...
function login_protection(){  
 if($_GET['github'] != 'doctorrm')
 	header('Location: /'); 
}
//修改WordPress后台默认登陆地址结束
...
function catch_rand_image() {
  ...
  ob_end_clean();
    $random = mt_rand(1, 4);
    $imgg_url = 'https://blog.harbournet.cn/wp-content/themes/svtheme/assets/images/'.$random.'.jpg';
    return $imgg_url;
