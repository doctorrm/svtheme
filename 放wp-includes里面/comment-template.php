...
function comment_form( $args = array(), $post_id = null ) {
	...
	$fields   =  array(
		...
		'author' => '<div class="comment-form-author"  style="float:left;margin-bottom:1em;margin-right:1em;width:30%;" >' . '<label for="author" style="font-size:12px;">' . __( 'Name' ) . ( $req ? ' <span class="required" style="color:red">（必填）</span>' : '' ) . '</label> ' .
		            '<input id="author" style="font-size:0.9em" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30" maxlength="245"' . $aria_req . $html_req . ' /></div>',
		
		'email'  => '<div class="comment-form-email" style="float:left;margin-bottom:1em;margin-right:1em;width:30%;" ><label for="email" style="font-size:12px" >' . __( 'Email' ) . ( $req ? ' <span class="required" style="color:red">（必填）</span>' : '' ) . '</label> ' .
		            '<input id="email" name="email"  style="font-size:0.9em"' . ( $html5 ? 'type="email"' : 'type="text"' ) . ' value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30" maxlength="100" aria-describedby="email-notes"' . $aria_req . $html_req  . ' /></div>',
		
		'url'    => '<div class="comment-form-url" style="float:left;margin-bottom:1em;margin-right:1em;width:30%;" ><label for="url" style="font-size:12px">' . __( 'Website' ) . '</label> ' .
		            '<input id="url" name="url"  style="font-size:0.9em"' . ( $html5 ? 'type="url"' : 'type="text"' ) . ' value="' . esc_attr( $commenter['comment_author_url'] ) . '" size="30" maxlength="200" /></div><br>',
	);
	...
	$defaults = array(
		...
		'title_reply_before'   => '<p id="reply-title" class="comment-reply-title" style="color:red">',
		'title_reply_after'    => '</p>',
